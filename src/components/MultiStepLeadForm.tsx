...
export default function MultiStepLeadForm() {
  ...
  if (submitted) {
    return (
      <div className="glass-panel p-8 rounded-2xl border border-white/10 glow-blue text-center max-w-xl mx-auto my-8">
            ...
            {servicesList.map((svc) => {
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-xl border text-left transition-all duration-200 cursor-none flex items-center justify-between ${
                    isSelected
                ...
                >
                  ...
                  {isSelected && <Check className="w-4 h-4 text-[#00D2FF]" />}
                </button>
              );
            })}
          </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 focus:border-[#00D2FF] rounded-lg px-4 py-2.5 text-sm outline-none text-white transition-all cursor-none"
              />
